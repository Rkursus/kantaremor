---
title: "Tidyderse - `dplyr` minimalistlikud näited"
output: 
  html_document:
    theme: null
---

Andmetabelist info kättesaamiseks kasutame R-i paketti *dplyr*, mis tuleb kaasa paketiga `tidyverse`. See pakett muudab mugavaks ja kiireks sageli ettetulevad operatsioonid nagu andmestiku filtreerimise, sorteerimise ja grupeerimise. Paketi süntaks omab mitmeidki ühisjooni SQL süntaksi või suuremahuliste andmete töötlemise keelega Pig Latin.
